(function () {
    ...
    let connection = new signalR.HubConnection("/hitCounter")
    //let connection = new signalR.HubConnection("/hitCounter", { transport: signalR.TransportType.LongPolling }); // need Longpolling when deploying, cause alpha
